...
import com.citytraffic.server.repository.CarRepository;
import com.citytraffic.server.service.CarService;
import com.citytraffic.server.service.dto.CarDTO;
import com.citytraffic.server.service.mapper.CarMapper;
...
public class CarResourceIntTest {
    ...
    public void createCar() throws Exception {
        ...
        assertThat(testCar.getQr()).isEqualTo(DEFAULT_QR);
    }
    ...
    public void updateCar() throws Exception {
        ...
        Car testCar = carList.get(carList.size() - 1);
        assertThat(testCar.getQr()).isEqualTo(UPDATED_QR);
    }
